   ...
   public void func_70071_h_() {
      ...
      if(this.field_70170_p.field_72995_K && this.field_70279_a) {
         ...
         if(this.field_70153_n != null && this.field_70153_n instanceof EntityLivingBase) {
            var6 = (double)((EntityLivingBase)this.field_70153_n).field_70701_bs;
            if(var6 > 0.0D) {
               var8 = -Math.sin((double)(this.field_70153_n.field_70177_z * 3.1415927F / 180.0F));
               var25 = Math.cos((double)(this.field_70153_n.field_70177_z * 3.1415927F / 180.0F));
               this.field_70159_w += var8 * this.field_70276_b * 0.05000000074505806D;
               this.field_70179_y += var25 * this.field_70276_b * 0.05000000074505806D;
            }
         }
