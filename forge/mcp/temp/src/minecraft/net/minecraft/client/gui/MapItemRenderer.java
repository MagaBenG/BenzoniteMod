...
public class MapItemRenderer {
   ...
   public void func_78319_a(EntityPlayer p_78319_1_, TextureManager p_78319_2_, MapData p_78319_3_) {
      ...
      for(Iterator var19 = p_78319_3_.field_76203_h.values().iterator(); var19.hasNext(); ++var20) {
         ...
         var17.func_78382_b();
         var17.func_78374_a(-1.0D, 1.0D, (double)((float)var20 * 0.0010F), (double)var21, (double)var12);
         var17.func_78374_a(1.0D, 1.0D, (double)((float)var20 * 0.0010F), (double)var13, (double)var12);
         var17.func_78374_a(1.0D, -1.0D, (double)((float)var20 * 0.0010F), (double)var13, (double)var14);
         var17.func_78374_a(-1.0D, -1.0D, (double)((float)var20 * 0.0010F), (double)var21, (double)var14);
         var17.func_78381_a();
         GL11.glPopMatrix();
      }
