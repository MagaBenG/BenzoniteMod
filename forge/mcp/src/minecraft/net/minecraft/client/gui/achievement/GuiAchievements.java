    ...
    protected void genAchievementBackground(int par1, int par2, float par3)
    {
        ...
        for (k3 = 0; k3 < achievementList.size(); ++k3)
        {
            ...
            if (j4 >= -24 && l3 >= -24 && j4 <= 224 && l3 <= 155)
            {
                ...
                renderitem.renderItemAndEffectIntoGUI(this.mc.fontRenderer, this.mc.func_110434_K(), achievement2.theItemStack, i5 + 3, l4 + 3);
                GL11.glDisable(GL11.GL_LIGHTING);
        ...
        {
            String s = I18n.func_135053_a(achievement1.getName());
            ...
            {
                i5 = Math.max(this.fontRenderer.getStringWidth(s), 120);
                String s2 = I18n.func_135052_a("achievement.requires", new Object[] {I18n.func_135053_a(achievement1.parentAchievement.getName())});
