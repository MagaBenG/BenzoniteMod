...
public class GuiScreenBook extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.editingTitle)
        {
            ...
            String s2 = String.format(I18n.func_135053_a("book.byAuthor"), new Object[] {this.editingPlayer.getCommandSenderName()});
        ...
        {
            s = String.format(I18n.func_135053_a("book.pageIndicator"), new Object[] {Integer.valueOf(this.currPage + 1), Integer.valueOf(this.bookTotalPages)});
            s1 = "";
