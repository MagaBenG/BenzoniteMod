        ...
        if (itemstack != null)
        {
            ...
            else
            {
                if (entityitem.getEntityItem().getItem() == Item.compass)
                {
                    ...
                    TextureAtlasSprite textureatlassprite = ((TextureMap)texturemanager.func_110581_b(TextureMap.field_110576_c)).func_110572_b(Item.compass.getIconIndex(entityitem.getEntityItem()).getIconName());
                ...
                if (entityitem.getEntityItem().getItem() == Item.compass)
                {
                    TextureAtlasSprite textureatlassprite1 = ((TextureMap)Minecraft.getMinecraft().func_110434_K().func_110581_b(TextureMap.field_110576_c)).func_110572_b(Item.compass.getIconIndex(entityitem.getEntityItem()).getIconName());
