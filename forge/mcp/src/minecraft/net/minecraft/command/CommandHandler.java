...
public class CommandHandler implements ICommandManager
{
    ...
    public int executeCommand(ICommandSender par1ICommandSender, String par2Str)
    {
            ...
            if (icommand.canCommandSenderUseCommand(par1ICommandSender))
            {
                ...
                if (i > -1)
                {
                    ...
                    for (int l = 0; l < k; ++l)
                    {
                        ...
                        {
                            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111082_b(commandexception.getMessage(), commandexception.getErrorOjbects()).func_111059_a(EnumChatFormatting.RED));
                        }
                    }
        ...
        {
            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111082_b("commands.generic.usage", new Object[] {ChatMessageComponent.func_111082_b(wrongusageexception.getMessage(), wrongusageexception.getErrorOjbects())}).func_111059_a(EnumChatFormatting.RED));
        }
        catch (CommandException commandexception1)
        {
            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111082_b(commandexception1.getMessage(), commandexception1.getErrorOjbects()).func_111059_a(EnumChatFormatting.RED));
        }
