...
public class BlueSapling extends BlockFlower
{
    public static final String[] WOOD_TYPES = new String[] {"Blue_Sapling"};
    private static final String[] field_94370_b = new String[] {"Blue_Sapling"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    public BlueSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
