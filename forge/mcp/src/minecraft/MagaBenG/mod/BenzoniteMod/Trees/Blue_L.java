...
public class Blue_L extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"Blue_L"};
    public static final String[][] field_94396_b = new String[][] {{"Blue_L"}};
    @SideOnly(Side.CLIENT)
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    int[] adjacentTreeBlocks;

    public Blue_L(int par1)
    {
        super(par1, Material.leaves, false);
        this.setTickRandomly(true);
        this.setCreativeTab(BenzoniteMod.tabBenzonite);
    }
    ...
    {
        return BenzoniteMod.Blue_Sapling.blockID;
    }
