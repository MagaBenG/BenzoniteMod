...
public class TallDoor extends Block
{
    ...
    public TallDoor(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon(this.func_111023_E() + "_upper");
        this.field_111043_b[0] = par1IconRegister.registerIcon(this.func_111023_E() + "_lower");
