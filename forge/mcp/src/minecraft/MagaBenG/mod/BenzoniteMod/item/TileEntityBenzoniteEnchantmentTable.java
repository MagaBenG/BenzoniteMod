...
public class TileEntityBenzoniteEnchantmentTable extends TileEntity
{
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Benzonite Enchantment Table", this.field_94136_s);
        }
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Benzonite Enchantment Table"))
        {
            this.field_94136_s = par1NBTTagCompound.getString("Benzonite Enchantment Table");
        }
    }
    ...
    {
        return this.func_94135_b() ? this.field_94136_s : "Benzonite Enchantment Table";
    }
