...
public class BenzoniteChestBlock extends BlockContainer
{
    ...
    public BenzoniteChestBlock(int par1, int par2)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityBenzoniteChest TileEntityBenzoniteChest = (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityBenzoniteChest != null)
        {
            TileEntityBenzoniteChest.updateContainingBlockInfo();
        }
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (TileEntityBenzoniteChest != null)
        {
            for (int j1 = 0; j1 < TileEntityBenzoniteChest.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityBenzoniteChest.getStackInSlot(j1);
    ...
    {
        Object object = (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Benzonite Crate", (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Benzonite Crate", (IInventory)object, (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Benzonite Crate", (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Benzonite Crate", (IInventory)object, (TileEntityBenzoniteChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        TileEntityBenzoniteChest TileEntityBenzoniteChest = new TileEntityBenzoniteChest();
        return TileEntityBenzoniteChest;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityBenzoniteChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
