...
public class BenzoniteSapling extends BlockSapling
{
    public static final String[] WOOD_TYPES = new String[] {"Red", "Blue", "Green", "Orange"};
    private static final String[] field_94370_b = new String[] {"sapling", "sapling_Blue", "sapling_Green", "sapling_Orange"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    protected BenzoniteSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
