...
import MagaBenG.mod.BenzoniteMod.Entity.TileEntityLightTable;
...
public class LightTable extends BlockEnchantmentTable
{
    {
    }
        ...
        for (int l = par2 - 2; l <= par2 + 2; ++l)
        {
            for (int i1 = par4 - 2; i1 <= par4 + 2; ++i1)
            {
                ...
                if (par5Random.nextInt(16) == 0)
                {
                    ...
                    {
                        if (par1World.getBlockId(l, j1, i1) == Block.glowStone.blockID)
                        {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityLightTable tileentityenchantmenttable = (TileEntityLightTable)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityLightTable)par1World.getBlockTileEntity(par2, par3, par4)).func_94134_a(par6ItemStack.getDisplayName());
        }
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("LightTable_Side");
        this.field_94461_a = par1IconRegister.registerIcon("LightTable_Top");
        this.field_94460_b = par1IconRegister.registerIcon("LightTable_Bottom");
    }
}
