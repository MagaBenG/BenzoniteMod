...
public class BenzoniteEnchant extends BlockContainer
{
    ...
    public BenzoniteEnchant(int par1)
    {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityBenzoniteEnchantmentTable tileentitybenzoniteenchantmenttable = (TileEntityBenzoniteEnchantmentTable)par1World.getBlockTileEntity(par2, par3, par4);
            par5EntityPlayer.displayGUIEnchantment(par2, par3, par4, tileentitybenzoniteenchantmenttable.func_94135_b() ? tileentitybenzoniteenchantmenttable.func_94133_a() : null);
            return true;
        }
    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityBenzoniteEnchantmentTable)par1World.getBlockTileEntity(par2, par3, par4)).func_94134_a(par6ItemStack.getDisplayName());
        }
    }
