...
public class OrangeBenzonitePresurePlate extends BlockBasePressurePlate
{
    /** The mob type that can trigger this pressure plate. */
    private EnumMobType triggerMobType;

    public OrangeBenzonitePresurePlate(int par1, String par2Str, Material par3Material, EnumMobType par4EnumMobType)
    {
