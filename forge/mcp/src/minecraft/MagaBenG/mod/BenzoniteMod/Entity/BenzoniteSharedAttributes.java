...
public class BenzoniteSharedAttributes
{
    ...
    public static final Attribute field_111263_d = (new RangedAttribute("generic.movementSpeed", 3.0D, 1.0D, Double.MAX_VALUE)).func_111117_a("Movement Speed").func_111112_a(true);
