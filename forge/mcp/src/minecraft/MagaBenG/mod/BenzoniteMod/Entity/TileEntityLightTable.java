...
public class TileEntityLightTable extends TileEntity
{
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Light Table", this.field_94136_s);
        }
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Light Table"))
        {
            this.field_94136_s = par1NBTTagCompound.getString("Light Table");
        }
    }
    ...
    {
        return this.func_94135_b() ? this.field_94136_s : "Light Table";
    }
